...
- The `01-ideas → 02-specs` and `02-specs → 03-ready` transitions are available as the `advance-task` skill (`.claude/skills/advance-task/SKILL.md`), which implements the exact procedure documented in `AGENTS.md`.
